  ...
  return (
    <>
      <Element id="footer" name="footer">
        <div className="bg-cloud-burst-600 w-full px-6">
          <div className="flex pb-8">
            <div className="p-7 w-2/3">
              <h3 className="text-2xl font-bold text-international-orange-600 ">
                Contact Us
              </h3>
              <section>
                <h2 className="text-lg font-bold text-international-orange-600 ">
                  {" "}
                  Email: <span className="italic">alumni@connect.com</span>
                </h2>
                <h2 className="text-lg font-bold text-international-orange-600 ">
                  {" "}
                  P.O Box : <span className="italic">28860-0100 </span>{" "}
                </h2>
                <h2 className="text-lg font-bold text-international-orange-600 ">
                  {" "}
                  Telephone:<span className="italic">0734567823 </span>
                </h2>
              </section>
            </div>
            <div>
              <h3 className=" pt-5 pb-5  text-2xl font-bold text-international-orange-600 ">
                Location
              </h3>
              <div>
                <iframe
