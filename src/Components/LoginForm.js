...
function Login( { user, updateUser }){
    ...
    return(
        <div className='p-3'> 
            <form onSubmit={(e) => handleSubmit(e)} className="flex flex-col gap-3  rounded-3xl border-solid border-white border-2 w-full md:w-2/4  m-auto  md:bg-cloud-burst-600 mt-20  " style={{ height: "80vh" }}>
            ...
            <label className="text-black text-sm md:text-white md:text-lg">
                ...
                <input type="submit" className='rounded-full text-white hover:bg-cloud-burst-600  bg-international-orange-600 hover:text-white w-40 p-3 m-auto' />
