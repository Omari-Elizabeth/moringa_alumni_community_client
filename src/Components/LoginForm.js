...
function Login( { user, updateUser }){
    ...
    return(
        <div className='p-3'> 
            <form onSubmit={(e) => handleSubmit(e)} className="flex flex-col gap-3  rounded-3xl border-solid border-white border-2  w-2/4 m-auto  bg-cloud-burst-600 mt-20  " style={{ height: "80vh" }}>
